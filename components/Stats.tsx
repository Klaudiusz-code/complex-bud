    ...
    <div className="max-w-[1400px] mx-auto px-5 sm:px-6 lg:px-10">
      <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-neutral-200 dark:divide-white/[0.06]">
        {[
          ...
          >
            <div className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-neutral-900 dark:text-white tracking-tight mb-1.5 sm:mb-2 group-hover:text-[#C7A568] transition-colors duration-300">
              {s.num}
              <span className="text-2xl sm:text-3xl md:text-4xl text-neutral-400 dark:text-neutral-600 group-hover:text-[#C7A568]/50 transition-colors">
                {s.suffix}
              </span>
            </div>
