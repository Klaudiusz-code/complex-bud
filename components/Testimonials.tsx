...
const testimonials = [
  ...
  {
    text: "Profesjonalizm na poziomie, którego nie spotkałam wcześniej w Polsce. Znajomość materiałów i technologii to coś niesamowitego.",
    name: "Anna K.",
    role: "Właścicielka apartamentu",
  },
  {
    text: "Od pierwszej wylewki do powieszenia obrazów — wszystko jedną ręką, bez stresu i pilnowania ekipy.",
    name: "Tomasz R.",
    role: "Deweloper",
  },
];
    ...
    <div className="max-w-[1400px] mx-auto px-5 sm:px-6 lg:px-10">
      <div className="text-center max-w-xl mx-auto mb-12 sm:mb-16">
        ...
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tighter mt-4 text-neutral-900 dark:text-white transition-colors">
          Zaufanie buduje się na wynikach
        </h2>
      </div>
